...
interface ParticleEffectWrapperProps {
  children: ReactNode;
  options?: CoolParticleOptions;
}

export const ParticleEffectWrapper: React.FC<ParticleEffectWrapperProps> = ({ children, options }) => {
  const ref = useRef<HTMLDivElement>(null); // Assuming Particles is a div
  ...
  // Directly render children and pass the ref
  return (
    <div ref={ref}>
