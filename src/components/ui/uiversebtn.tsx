        ...
        <>
            <StyledWrapper>
                <button className="button">
                    <div className="bg" />
                    <svg className="splash" width={342} height={208} viewBox="0 0 342 208" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M48.5 102.3C48.5 102.3 36.2 92.5 24.8 98.7C13.4 104.9 3 98.7 3 98.7" strokeWidth={3} strokeLinecap="round" />
                        <path d="M290.5 102.3C290.5 102.3 302.8 92.5 314.2 98.7C325.6 104.9 339 96.2 339 96.2" strokeWidth={3} strokeLinecap="round" />
                        <path d="M278.5 68.2C278.5 68.2 284.3 54.1 298.7 52.8C313.1 51.5 315.5 42.3 315.5 42.3" strokeOpacity="0.4" strokeWidth={3} strokeLinecap="round" />
                        <path d="M278.5 141.7C278.5 141.7 284.3 155.8 298.7 157.1C313.1 158.4 315.5 167.6 315.5 167.6" strokeOpacity="0.4" strokeWidth={3} strokeLinecap="round" />
                        <path d="M225.3 60.8C225.3 60.8 221.5 45.2 231.2 35.6C240.9 26 239.8 19.5 239.8 19.5" strokeWidth={3} strokeLinecap="round" />
                        <path d="M225.3 153.2C225.3 153.2 221.5 168.8 231.2 178.4C240.9 188 239.8 194.5 239.8 194.5" strokeWidth={3} strokeLinecap="round" />
                    </svg>
                    <div className="wrap">
                        <svg className="path" width={221} height={42} viewBox="0 0 221 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M182.674 2H203C211.837 2 219 9.16344 219 18V24C219 32.8366 211.837 40 203 40H18C9.16345 40 2 32.8366 2 24V18C2 9.16344 9.16344 2 18 2H47.8855" strokeWidth={3} strokeLinecap="round" />
                        </svg>
                        <div className="outline" />
                        <div className="content">
                            <div className="char state-1">
                                <span data-label="E">E</span>
                                <span data-label="x">x</span>
                                <span data-label="p">p</span>
                                <span data-label="l">l</span>
                                <span data-label="o">o</span>
                                <span data-label="r">r</span>
                                <span data-label="e">e</span>
                            </div>
                            <div className="icon">
                                <div />
