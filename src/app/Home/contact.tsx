...
//         //web3 forms 
//         const Newsletter = "Subscribe to Our Newsletter"; // This matches your file name tech-trio
...
//             formData.append("Newsletter", Newsletter); // Add course name
...
//                                 </form>
//                                 <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800">Thank you for subscribing</h1>
